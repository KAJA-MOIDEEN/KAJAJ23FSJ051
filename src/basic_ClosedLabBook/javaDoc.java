...
public class javaDoc{
	    /**
	     * This is the main method that executes when the program is run.
	     * It takes user input for the number of students, the number of subjects,
	     * and the marks for each student, and then calls the calculateResults method.
	     */
	    ...
	    /**
	     * This method calculates and displays the results for each student.
	     * It takes a 2D array of marks as input and calculates the total marks,
	     * average marks, and grade for each student, displaying the results.
	     */
