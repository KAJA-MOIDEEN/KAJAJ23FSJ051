...
public class Patient implements Comparable<Patient> {
	...
	public static void main(String[] args) {
		...
		Patient patient1 = new Patient(UUID.randomUUID(), "John", "Doe", 5, 3);
		patient1.addExposureId(exposure1);
		patient1.addDiseaseId(diseaseId1);

		Patient patient2 = new Patient(UUID.randomUUID(), "Alice", "Smith", 5, 3);
		patient2.addExposureId(exposure2);
		patient2.addDiseaseId(diseaseId2);

		Patient patient3 = new Patient(UUID.randomUUID(), "John", "Doe", 5, 3);
